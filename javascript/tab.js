(function(){
    ...
    var propTabs = {
        primer_encabezado: document.getElementById('encabezado_canciones').firstElementChild,
        primer_contenido: document.getElementById('contenido_canciones').firstElementChild,
        enlaces_encabezado: document.querySelectorAll('#encabezado_canciones li a'),
        li_encabezado: document.querySelectorAll('#encabezado_canciones li'),
        divs_contenido: document.querySelectorAll('#contenido_canciones > div'),
