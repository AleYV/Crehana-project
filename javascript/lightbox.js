(function(){
    ...
    /*Creamos un objeto para las propiedades */
    var propLightbox = {
    ...
    /*Creamos un objeto para los métodos*/
    var metLightbox ={
        inicio: function(){
        ...
        capturaImagen: function(){
            propLightbox.imagenCapturada = this;    /*Nos quedamos con la imagen capturada*/
            metLightbox.lightbox(propLightbox.imagenCapturada);
        },
    
        /*Nos quedamos con el url de la imagen que queremos */
        lightbox: function(imagenCapturada){
            propLightbox.imagenSrc = window.getComputedStyle(imagenCapturada,null).backgroundImage.slice(5,-2); /*slice: cortar una parte (posiciones a cortar al principio,posiciones a cortar), positivo para el inicio, negativo para final  */
                                                                /* backgroundImage: Permite acceder a las propiedades css del objeto (Elemento del cual quiero obtener el estilo, pseudoelemento del elemento) */
